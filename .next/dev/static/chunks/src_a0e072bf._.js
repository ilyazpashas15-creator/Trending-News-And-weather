...
const fetchTopHeadlines = async (category, country = 'in', pageSize = 20, page = 1, useWorldAPI = false)=>{
    const newsDataKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_NEWS_API_KEY || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEWS_API_KEY;
    ...
    const loadNews = async ()=>{
        try {
            ...
            if (searchQuery.trim()) {
                ...
                newsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$newsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNewsByQuery"])(searchQuery);
            } else if (selectedCity) {
                // If a city is selected, search for news from that city
                const cityQuery = `${selectedCity} ${selectedState}`;
                newsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$newsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNewsByQuery"])(cityQuery);
                ...
                newsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$newsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNewsByQuery"])(stateQuery);
            } else {
...
//# sourceMappingURL=src_a0e072bf._.js.map