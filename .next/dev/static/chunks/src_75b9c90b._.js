    ...
    return new Promise((resolve, reject)=>{
        setTimeout(()=>{
            ...
            if (credentials.email && credentials.password) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setStoredUser"])(mockUser);
                resolve(mockUser);
            } else {
...
const logout = async ()=>{
    ...
    return new Promise((resolve)=>{
        setTimeout(()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeStoredUser"])();
            resolve();
        }, 300); // Simulate network delay
    });
};
const getCurrentUser = ()=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoredUser"])();
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const storedUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
            setUser(storedUser);
            setLoading(false);
        }
    }["AuthProvider.useEffect"], []);
    const login = async (credentials)=>{
        ...
        setError(null);
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(credentials);
            setUser(userData);
        } catch (err) {
    ...
    const register = async (credentials)=>{
        ...
        setError(null);
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(credentials);
            setUser(userData);
        } catch (err) {
...
"[project]/src/app/ClientWrapper.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_75b9c90b._.js.map