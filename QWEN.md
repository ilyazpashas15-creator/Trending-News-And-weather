# MyWeatherApp - Project Context

## Project Overview
MyWeatherApp is a modern weather application built with Next.js, TypeScript, and Tailwind CSS. The application fetches and displays current weather data and forecasts for various locations. It uses the Visual Crossing API for weather data and includes fallbacks to mock data for better reliability. The project also includes calendar functionality with multiple calendar types (monthly, yearly, holiday, event, custom).

## Technologies Stack
- **Framework**: Next.js 16.0.1 (React-based with App Router)
- **Language**: TypeScript
...
├── ProjectStructure.md       # Detailed project structure documentation
├── README.md                 # Project documentation
├── tailwind.config.ts        # Tailwind CSS configuration
├── Task.md                   # Task requirements for weather app
├── Task1.md                  # Task requirements for calendar functionality
├── tsconfig.json             # TypeScript configuration
└── Warnings.md               # Project warnings
```
...
- Multiple calendar types (monthly, yearly, holiday, event, custom)
- Interactive calendar UI with proper navigation
...
- **calendar/**: Calendar functionality with various calendar types
...
- React functional components with hooks are used throughout
- ESLint and Prettier ensure consistent code formatting
- Components are small and focused with single responsibility
- Custom hooks are used to share logic between components
- Context API manages application state
- Tailwind CSS is used for styling with responsive design